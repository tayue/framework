...
namespace Framework\Core\model\relation;
...
use Framework\Core\model\Pivot;
...
class BelongsToMany extends Relation
{
    ...
    {
        $class = $this->pivotName ?: '\\Framework\Core\\model\\Pivot';
        ...
        throw new Exception('pivot model must extends: \Framework\Core\model\Pivot');
    }
