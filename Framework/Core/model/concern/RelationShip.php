...
namespace Framework\Core\model\concern;

use Framework\Core\Collection;
use Framework\Core\Db;
use Framework\Core\db\Query;
use Framework\Core\Model;
use Framework\Core\model\Relation;
use Framework\Core\model\relation\BelongsTo;
use Framework\Core\model\relation\BelongsToMany;
use Framework\Core\model\relation\HasMany;
use Framework\Core\model\relation\HasManyThrough;
use Framework\Core\model\relation\HasOne;
use Framework\Core\model\relation\MorphMany;
use Framework\Core\model\relation\MorphOne;
use Framework\Core\model\relation\MorphTo;
...
trait RelationShip
{
    ...
    protected function isRelationAttr($attr)
    {
        ...
        if (method_exists($this, $relation) && !method_exists('Framework\Core\Model', $relation)) {
            return $relation;
        }
