...
use Framework\Core\db\exception\BindParamException;
use Framework\Core\db\exception\DataNotFoundException;
use Framework\Core\db\exception\DbException;
use Framework\Core\db\exception\ModelNotFoundException;
use Framework\Core\db\exception\PDOException;
use Framework\Core\Exception;
use Framework\Core\Model;
use Framework\Core\model\Relation;
use Framework\Core\model\relation\OneToOne;
...
class Query
{
     ...
     *                            list_rows:每页数量
     *                            type:分页类名
     * @return \Framework\Core\Paginator
     * @throws DbException
     */
    public function paginate($listRows = null, $simple = false, $config = [])
    {
        ...
        /** @var Paginator $class */
        $class = false !== strpos($config['type'], '\\') ? $config['type'] : '\\Framework\Core\\paginator\\driver\\' . ucwords($config['type']);
