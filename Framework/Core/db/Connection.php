...
abstract class Connection
{
    ...
    public static function instance($config = [], $name = false)
    {
        ...
        if (true === $name || !isset(self::$instance[$name])) {
            ...
            $class = false !== strpos($options['type'], '\\') ? $options['type'] : '\\Framework\Core\\db\\connector\\' . ucwords($options['type']);
            // 记录初始化信息
    ...
    public function getBuilderClass()
    {
        ...
        return $this->getConfig('builder') ?: '\\Framework\Core\\db\\builder\\' . ucfirst($this->getConfig('type'));
    }
